...
class Point:
    ...
    @cache_on_first_arg
    def get_my_fear_at(self, other, shade_positions: Dict[Point, Shade]) -> int:
        """
    ...
    @cache_on_first_arg
    def get_my_enemy_fears_at(self, other, shade_positions: Dict[Point, Shade]) -> Dict[Shade, int]:
        """
